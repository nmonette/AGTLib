...
def test_n_reinforce():
    ...
    team.load_state_dict(torch.load("./output/experiment-2/end-3x3-team-policy-n-reinforce.pt"))
    adv.load_state_dict(torch.load("./output/experiment-2/end-3x3-adv-policy-n-reinforce.pt"))
